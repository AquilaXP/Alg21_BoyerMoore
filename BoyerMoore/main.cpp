...
{
    Testing testing;
    testing.Load( "string_matching_test_cases_31272_751472-57251-751472.tsv" );
    testing.Execute( FindSubString, "FindSubString" );
    testing.Execute( BoyerMoore, "BoyerMoore" );
    testing.Execute( BoyerMooreHorspe, "BoyerMooreHorspe" );
